...
exports = module.exports = function(options) {
  ...
  var extIncludes = options.include || [
    '.html',
  ];
  ...
  return function sitemap(page, next) {
    ...
    for (i = 0, len = pages.length; i < len; i++) {
      ...
      url = urlset.e('url');
      url.e('loc', res.fullURL);
      if (res.modifiedAt) { url.e('lastmod', res.modifiedAt.toISOString().substring(0,19)+'+00:00'); }
      
      res.isInSitemap = true;
    }
