...
exports = module.exports = function(options) {
  ...
  return function sitemap(page, next) {
    ...
    for (i = 0, len = pages.length; i < len; i++) {
      ...
      //console.log('--');
      //console.log(page.absoluteURL + ' <> ' + res.absoluteURL)
      
      var rto = path.relative(page.absoluteURL, res.absoluteURL || res.url);
      //var rto = path.relative(res.absoluteURL, page.absoluteURL);
      //console.log(rto);
